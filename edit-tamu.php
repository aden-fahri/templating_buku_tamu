     ...
     <div class="card-body">
       <form method="post" action="">
         ...
         <div class="form-group row">
           ...
           <div class="col-sm-8">
             <input type="text" class="form-control" name="bertemu" id="bertemu" value="<?= $data['bertemu'] ?>">
           </div>
         </div>
         ...
         <div class="form-group row">
           ...
           <div class="col-sm-8 d-flex justify-content-end">
             <a type="button" class="btn btn-danger btn-icon-split mr-2" href="buku-tamu.php">
